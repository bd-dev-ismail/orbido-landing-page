    ...
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        <div className="md:max-w-md text-center lg:text-start lg:col-span-2">
          ...
          >
            ...
            <span className="ml-2 text-2xl font-bold tracking-wide text-white uppercase">
              Or<span style={{ color: "rgba(214, 147, 0, 1)" }}>bido</span>
            </span>
          </a>
        ...
        <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-3">
          ...
          <div>
            <p className="font-semibold tracking-wide text-white">Community</p>
            <ul className="mt-2 space-y-2">
              <li>
                <a
                  style={{ color: "rgba(255, 255, 255, 0.7)" }}
          ...
          <div>
            <p className="font-semibold tracking-wide text-white">Partner</p>
            <ul className="mt-2 space-y-2">
              <li>
                <a
                  style={{ color: "rgba(255, 255, 255, 0.7)" }}
